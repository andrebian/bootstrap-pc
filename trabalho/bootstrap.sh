...
echo ""
# PHP e devs
apt-get install -y apache2 php5 php-auth php-codecoverage php-invoker php-pear curl php5-curl php5-imagick php5-mcrypt php5-mysql php5-pgsql php5-sqlite php5-xdebug phpmyadmin mysql-client-5.5 mysql-server-5.5 mysql-workbench mysql-utilities openjdk-7-jdk git
echo "- Ok"
echo ""
